...
namespace Kinect
{
    ...
    public class KinectCircleButton : ButtonBase
    {
        /// <summary>
        ...
        {
            ContentPresenter contentPresenter = this.Template.FindName("PART_DefaultContentPresenter", this) as ContentPresenter;
